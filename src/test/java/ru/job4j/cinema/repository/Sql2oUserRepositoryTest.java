...
class Sql2oUserRepositoryTest {
    ...
    public void whenSaveEqualsUsersThenGetEmptyOptional() {
        var u1 = new User(1, "name1", "test@mail.ru", "123");
        var u2 = new User(2, "name2", "test@mail.ru", "1234");
    ...
    public void whenSaveThenGetSame() {
        var user = sql2oUserRepository.save(new User(0, "name3", "test1@mail.ru", "123")).get();
